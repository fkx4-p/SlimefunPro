        ...
        final Runnable task1 = new Runnable() {
...

            {
                try {
                    ...
                    Slimefun.getLogger().log(Level.WARNING, "Unable to obtain Unsafe by getUnsafe", e);
                }
                if (unsafe == null)
                    try {
                        ...
                        Slimefun.getLogger().log(Level.WARNING, "Unable to obtain Unsafe by reflection", e);
