...
public final class Categories {
    ...
    public static final Category COMPRESSED_ITEMS = new Category(new NamespacedKey(SlimefunPlugin.instance, "compressed items"), new CustomItem(Material.PISTON, "&7Compressed Items"), 1);
