...
public final class Categories {
    ...
    public static final Category COMPRESSED_ITEMS = new Category(new NamespacedKey(SlimefunPlugin.instance, "compressed_items"), new CustomItem(SlimefunItems.ELECTRIC_PRESS, "&7Compressed Items"), 1);
